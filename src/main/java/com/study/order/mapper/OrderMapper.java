...
import com.study.order.dto.OrderCoffeeResponseDto;
 ...
 * <ul>
 *     <li>
 *         {@link com.study.order.mapper.OrderMapper#orderToOrderResponseDto(Order)}가 Solution 코드에 맞게 수정되었습니다.
 *     </li>
 *     <li>
 *         {@link com.study.order.mapper.OrderMapper#orderCoffeeToOrderCoffeeResponseDto(OrderCoffee)}가
...
public interface OrderMapper {
     ...
     *         {@link com.study.order.mapper.OrderMapper#orderCoffeeToOrderCoffeeResponseDto(OrderCoffee)}를 호출해
     ...
     * <ul>
     *     <li>
     *         이 {@link com.study.order.mapper.OrderMapper#orderCoffeeToOrderCoffeeResponseDto(OrderCoffee)}는
     *         {@link com.study.order.mapper.OrderMapper#orderToOrderResponseDto(Order)} 내부에서
     ...
     *         <a href="https://github.com/codestates-seb/be-solution-jpa/blob/7e6e098edc80f5bbfef43db2ab3edd01afa27ed8/src/main/java/com/codestates/coffee/entity/Coffee.java" target="_blank">
     *              Coffee
     *         </a>의 price({@link com.study.values.Money} 타입)와 타입이 일치하지 않으므로,
