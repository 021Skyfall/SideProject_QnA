 ...
 *     </li>
 *     <li>
 *         {@link com.study.audit.Auditable}
 *         <ul>
 *             <li>
 *                 {@link com.study.audit.Auditable} 클래스는 엔티티 클래스마다 공통으로 존재하는 엔티티 생성일, 수정일, 작성자 등의
...
public class Coffee extends Auditable {
    ...
    */
     ...
     *             </li>
     *             <li>
     *                 여기서는 {@link com.study.values.Money} 클래스의 value 필드를 Coffee Entity의 필드로 포함시킵니다.
     *             </li>
     *         </ul>
     *     </li>
     *     <li>
     ...
     *             </li>
     *             <li>
     *                 name="value"의 "value"는 {@link com.study.values.Money} 클래스의 필드입니다.
     *             </li>
     *             <li>
